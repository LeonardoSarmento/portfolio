...
const InputWithBorderEffect = React.forwardRef<HTMLInputElement, InputProps>(({ className, type, ...props }, ref) => {
...
InputWithBorderEffect.displayName = 'InputWithBorderEffect';

export { InputWithBorderEffect };
