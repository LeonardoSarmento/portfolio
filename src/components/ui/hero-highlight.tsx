...
export const HeroHighlight = ({
  ...
  return (
    <div
      className={cn('group relative flex h-full w-full items-center justify-center bg-background', containerClassName)}
...
export const Highlight = ({ children, className }: { children: React.ReactNode; className?: string }) => {
  return (
    <motion.span
      ...
      className={cn(
        `relative inline-block rounded-lg bg-gradient-to-r from-teal-400 to-yellow-200 px-1 pb-1 dark:from-emerald-500 dark:to-emerald-900`,
        className,
      )}
    >
      {children}
