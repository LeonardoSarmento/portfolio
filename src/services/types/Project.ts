...
export const CreateProjectSchema = ProjectSchema.omit({ id: true, thumbnail: true, date: true });
export type CreateProjectType = z.infer<typeof CreateProjectSchema>;

export const EditProjectSchema = ProjectSchema.omit({ id: true, date: true });
