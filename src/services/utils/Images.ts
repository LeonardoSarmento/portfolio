...
export const PENDING_PHOTO = new URL('/public/assets/pending-photo.svg', import.meta.url).href;
...
export const LEO_DIA_D = new URL('/public/assets/leonardo-dia-d-with-qrcode.svg', import.meta.url).href;
export const LEO_BARZINHO = new URL('/public/assets/leo-barzinho.jpg', import.meta.url).href;
export const QRCODE_GORJETA = new URL('/public/assets/qrcodegorjeta.jpeg', import.meta.url).href;
